...
#define MIN_PULSE 2000  // Min pulse of this servo is 600us, but each tick of our timer is 0.5us
#define MAX_PULSE 4000  // Max pulse of this servo is 2400us, but each tick of our timer is 0.5us
...
// Test function to set the Servo angle
void setServoTest(){
// Control servo position based on angle
   //TCCR1A |= (1 << COM1A1); //enables servo
   setPos(25);
   _delay_ms(2000);
   setPos(155);
   _delay_ms(2000);
